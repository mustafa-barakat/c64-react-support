  ...
  return (
    ...
    >
      <div className='fixed bottom-4 right-4'>
        <button className='rounded-full bg-blue-500 px-4 py-2 font-bold text-white hover:bg-blue-700 max-w-sm'>
          <svg
            width='50px'
            height='50px'
            viewBox='0 0 64 64'
      ...
      <div className='fixed bottom-2 right-2 z-50 max-w-xs max-h-120'>
        <div className='rounded-lg bg-white shadow-lg'>
          ...
          {/* <!-- Messages --> */}
          <div className='px-4 py-2 overflow-auto max-h-72 '>
            <div className='mb-2 text-center text-sm text-gray-500'>June 19th, 2023</div>

            <div className='flex flex-col space-y-2 s'>
              ...
              <div className='flex items-end justify-end'>
                <div className='rounded-lg bg-blue-500 p-2 text-white'>
                  <p
                    className='text-sm whitespace-normal over w-60
              break-all h-auto'
                  >
